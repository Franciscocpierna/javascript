...
document.querySelectorAll('.banner').forEach(banner => {
    ...
    banner.addEventListener('click', function() {
        ...
        window.open('https://www.udemy.com/course/python-rpa-e-excel-aprenda-automatizar-processos-e-planilhas/?referralCode=75F06FB2C5443C0A1FBF&couponCode=LETSLEARNNOWPP', '_blank');
